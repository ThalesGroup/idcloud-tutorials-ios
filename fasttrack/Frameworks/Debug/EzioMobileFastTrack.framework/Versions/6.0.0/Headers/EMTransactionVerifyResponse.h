 ...
 * - Since: 5.3
 */
typedef NS_ENUM(NSUInteger, EMTransactionVerifyResponseValue){
    
    /**
     * Transaction verify response value as ACCEPTED
     */
    EMTransactionVerifyResponseValueAccepted,
    
    /**
     * Transaction verify response value as REJECTED
     */
    EMTransactionVerifyResponseValueRejected
};
...
/**
 * Gets the response value. See enum EMTransactionVerifyResponseValue.
 *
 * @return The response.
 */
@property (nonatomic, assign, readonly) EMTransactionVerifyResponseValue response;
