...
````
 ...
 <li>
 **Login.** Next, you simply need to login using -loginWithPassword:error: or its asynchronous equivalent -loginWithPassword:completionHandler: to unlock all functionalities represented by the EMPasswordDomain. The EMPasswordManager will remain logged in until -logout: is called.
 ...
 **No Password**<br />
 ...
 @see EMEzioMobileContext, EMPasswordDomain
 ...
 * - Since: 3.0
 */
- (BOOL)isPasswordSet:(NSError **)anError NS_SWIFT_UNAVAILABLE("Use -isPasswordSet for Swift Instead");;
 ...
 * - Since: 3.0
 */
- (BOOL)isLoggedIn:(NSError **)anError NS_SWIFT_UNAVAILABLE("Use -isLoggedIn for Swift Instead");
...
/**
 * The reset of the password manager, will delete all files and keychains of password manager, OOB, and SecureStorage.
 * Token data will not be impacted.
 *
